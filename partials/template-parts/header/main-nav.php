		...
		<div class="uk-container uk-container-large">
			<div class="uk-flex uk-flex-middle uk-flex-between" uk-navbar="">
				...
				<div class="uk-flex uk-flex-middle uk-flex-between">
					<a href="#modal-menu" uk-toggle><svg class="hamburger" width="30" height="23" viewBox="0 0 30 23" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 1.42383H30M0 11.4238H30M0 21.4238H30" stroke="currentColor" stroke-width="2"/></svg></a>
